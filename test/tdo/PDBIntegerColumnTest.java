 ...
 * @author valery
 */
public class PDBIntegerColumnTest extends DataColumnTestBase {

    @Override
    protected DataColumn createDataColumn() {
        DataColumn dc = new DataColumn.PDBIntegerColumn();
        return dc;
    }
    ...
    public void testCreateBlankObject() {
        ...
        Integer defaultValue = (Integer) instance.getDefaultValue();
