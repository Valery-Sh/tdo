 ...
 * @author valery
 */
public class PDBTimestampColumnTest extends DataColumnTestBase {

    @Override
    protected DataColumn createDataColumn() {
        DataColumn dc = new DataColumn.PDBTimestampColumn();
        return dc;
    }
    ...
    public void testGetType() {
        ...
        assertEquals(java.sql.Timestamp.class, result);
    }
    ...
    public void testCreateBlankObject() {
        ...
        java.sql.Timestamp defaultValue = (java.sql.Timestamp) instance.getDefaultValue();
    ...
    public void testCompareObjects_3args() {
        ...
        obj = null;
        anotherObj = new java.sql.Timestamp(2);
        instance = createDataColumn();
        expResult = -1;
        ...
        // first == second 
        expResult = 0;
        obj = new java.sql.Timestamp(2);
        result = instance.compareObjects(obj, anotherObj, nullMin);
        assertEquals(expResult, result);

        // first < second 
        expResult = -1;
        obj = new java.sql.Timestamp(1);
        result = instance.compareObjects(obj, anotherObj, nullMin);
        assertEquals(expResult, result);

        // first > second 
        expResult = 1;
        obj = new java.sql.Timestamp(3);
        anotherObj = new java.sql.Timestamp(1);
        result = instance.compareObjects(obj, anotherObj, nullMin);
        assertEquals(expResult, result);
    ...
    public void testDefaultValueInstance() {
        ...
        DataColumn instance = createDataColumn();
        Object expResult = new java.sql.Timestamp(0);
        Object result = instance.blankValueInstance();
        assertEquals(expResult, result);

        Object obj = new java.sql.Timestamp(1000);
        instance = createDataColumn();
        instance.setDefaultValue(obj);
        expResult = new java.sql.Timestamp(1000);
