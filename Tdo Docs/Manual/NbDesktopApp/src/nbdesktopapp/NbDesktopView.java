 ...
 */
public class NbDesktopView extends FrameView {
    
    public NbDesktopView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        nbdesktopapp.Customer c = new nbdesktopapp.Customer();
        System.out.println("1. c.purchaseOrder=" + c.getPurchaseOrderCollection());
        ...
        setSaveNeeded(true);
        System.out.println("2. c.purchaseOrder=" + c.getPurchaseOrderCollection());
    }

    @Action(enabledProperty = "recordSelected")
    public void deleteRecord() {
        int[] selected = masterTable.getSelectedRows();
        List<nbdesktopapp.Customer> toRemove = new ArrayList<nbdesktopapp.Customer>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            nbdesktopapp.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    public void newDetailRecord() {
        ...
        nbdesktopapp.Customer c = list.get(masterTable.convertRowIndexToModel(index));
        Collection<nbdesktopapp.PurchaseOrder> ps = c.getPurchaseOrderCollection();
        if (ps == null || ps.isEmpty()) {
            ps = new LinkedList<nbdesktopapp.PurchaseOrder>();
            c.setPurchaseOrderCollection((List)ps);
        }
        nbdesktopapp.PurchaseOrder p = new nbdesktopapp.PurchaseOrder();
    ...
    public void deleteDetailRecord() {
        ...
        List<nbdesktopapp.PurchaseOrder> toRemove = new ArrayList<nbdesktopapp.PurchaseOrder>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<nbdesktopapp.PurchaseOrder> iter = ps.iterator();
            while (count++ < selected[idx]) iter.next();
            nbdesktopapp.PurchaseOrder p = iter.next();
            toRemove.add(p);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<nbdesktopapp.Customer> merged = new ArrayList<nbdesktopapp.Customer>(list.size());
                for (nbdesktopapp.Customer c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = NbDesktopApp.getApplication().getMainFrame();
            aboutBox = new NbDesktopAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        NbDesktopApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(nbdesktopapp.NbDesktopApp.class).getContext().getResourceMap(NbDesktopView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(nbdesktopapp.NbDesktopApp.class).getContext().getActionMap(NbDesktopView.class, this);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(detailScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 729, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(newButton))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(detailScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveButton)
                    .addComponent(refreshButton)
    ...
    private java.util.List<nbdesktopapp.Customer> list;
