...
public class PurchaseOrder implements Serializable {
    ...
    public String toString() {
        return "nbdesktopapp.PurchaseOrder[orderNum=" + orderNum + "]";
    }
